...
if(isset($_POST['addwarmmatch']))
{
	...
	$t2id=$row2['t_id'];
	$type="warm up";
	$q2="insert into matches(type,match_date,team_1,result,mom,team_2,match_venue,umpire_1,umpire_2) values('$type','$mdate',$t1id,'$result','$mom',$t2id,'$venue','$u1','$u2')";
