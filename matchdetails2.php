...
<html lang="en">
  ...
  <div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="details2.php" onsubmit="return presubmit()" method="post">
			<div class="h3"></div>
				...
				$con=mysqli_connect('localhost','root');
							...
							mysqli_close($con);
				?><div class="h3"><div class="label label-success"><?php echo 'Batting:  '.strtoupper($row2['name']) ?></div></div>
				<input type="hidden" name="bat_team" value="<?php echo $show ?>"/>
							...
							<tr>
								...
								<td>
									...
									<option>--select bowler--</option>
										...
										for($j=1;$j<=11;$j++)
										{
											?><option><?php echo strtoupper($row1['player_'.$j]) ?></option>
						<?php			}
										?>
									</select>
									</div>
				...
				<div class="form-group">
					...
					<input type="number" required name="extra" id="extras" class="form-control"/>
				</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="h3"></div>
				<div class="table-responsive">
				<div class="h3"><div class="label label-success"><?php echo 'Bowling:  '.strtoupper($row1['name']) ?></div></div>
				<input type="hidden" name="bowl_team" value="<?php echo $row1['t_id'] ?>"/>
					<table class="table table-hover">
						<thead>
							<th>Player</th>
							<th>Did not bowl</th>
